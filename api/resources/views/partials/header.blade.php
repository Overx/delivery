    ...
    <div class=" pull-left sm-table hidden-xs hidden-sm">
        <div class="header-inner">
            ...
            <ul class="notification-list no-margin hidden-sm hidden-xs b-grey b-l b-r no-style p-l-30 p-r-20">
             ...
             -->
            <a href="#" class="search-link" data-toggle="search"><i class="pg-search"></i>Clique aqui para <span class="bold">busca</span></a> </div>
    </div>
    <div class=" pull-right">
        <div class="header-inner">
    ...
    <div class=" pull-right">
        ...
        <div class="visible-lg visible-md m-t-10">
            <div class="pull-left p-r-10 p-t-10 fs-16 font-heading">
                <span class="semi-bold">Victor</span> <span class="text-master">Salatiel</span>
            </div>
            <div class="dropdown pull-right">
                ...
                <ul class="dropdown-menu profile-dropdown" role="menu">
                    <li><a href="#"><i class="pg-settings_small"></i> Opções</a>
                    </li>
                    <li><a href="#"><i class="pg-outdent"></i> Suporte</a>
                    </li>
